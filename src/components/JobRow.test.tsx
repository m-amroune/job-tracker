...
describe("JobRow", () => {
  ...
  test("displays the application information", () => {
    ...
    expect(screen.getByRole("link", { name: "Open job offer for Nova Digital" })).toHaveAttribute(
      "href",
  ...
  test("starts editing the application", () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: "Edit Nova Digital" }));
  ...
  test("updates the position field", () => {
    ...
    expect(updateJob).toHaveBeenCalledWith("1", "position", "React Developer");
  });
  ...
  test("resets the application status", () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: "Reset status for Nova Digital" }));
  ...
  test("deletes the application after confirmation", () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: "Delete Nova Digital" }));
...
test("updates the follow-up date", () => {
  ...
  fireEvent.change(screen.getByLabelText("Follow-up date for Nova Digital"), {
    target: { value: "2026-08-25" },
  });

  expect(updateJob).toHaveBeenCalledWith("1", "followUpDate", "2026-08-25");
});
